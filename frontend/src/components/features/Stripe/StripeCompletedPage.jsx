    ...
    useEffect(() => {
        ...
        stripe.retrievePaymentIntent(clientSecret).then(({paymentIntent}) => {
            ...
            const savePaymentInfo = async () => {
                const orderResponse = await OrderService.getOrderDataByClientSecret(clientSecret);
                ...
                <div id="payment-status-container">
                    {
                        status === 'succeeded'
                            ? <div className='title'>
                                ...
                                <PageTitle>
                                    <PageTitle.Text>The landlord will contact you</PageTitle.Text>
                                </PageTitle>
                            </div>
                            : null
                    }
                    ...
                    <div id="payment-status">
                        ...
                        {intentId && <div id="details-table">
                            <table>
                                <tbody>
                                    ...
                                    <tr>
                                        <td className="TableLabel">Your name</td>
                                        <td className="TableContent">{order.name}</td>
                                    </tr>
                                    <tr>
                                        <td className="TableLabel">Pickup location</td>
                                        <td className="TableContent">{order.pickupLocation}</td>
                                    </tr>
                                    <tr>
                                        <td className="TableLabel">Amount</td>
                                        <td className="TableContent"><span style={{fontWeight: 'bold'}}>{order.totalPrice} €</span></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>}
                        {intentId && <a href={`https://dashboard.stripe.com/payments/${intentId}`} id="view-details"
                            rel="noopener noreferrer" target="_blank">View details
                        ...
                        <a id="retry-button" href={routes.home}>Go home</a>
                    </div>
                </div>
            </div>
        </>
